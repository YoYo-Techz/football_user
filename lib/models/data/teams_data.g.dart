...
class _$TeamsData extends TeamsData {
  ...
  _$TeamsData._({this.id, this.name, this.logo, this.country}) : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc($jc(0, id.hashCode), name.hashCode), logo.hashCode),
        country.hashCode));
  }
...
class TeamsDataBuilder implements Builder<TeamsData, TeamsDataBuilder> {
  ...
  _$TeamsData build() {
    final _$result = _$v ??
        new _$TeamsData._(id: id, name: name, logo: logo, country: country);
    replace(_$result);
    return _$result;
  }
}
